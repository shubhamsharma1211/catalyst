...
<?php if ( 'uptime' === $module ) : ?>
	<div class="sui-box-settings-row schedule-box <?php echo $enabled ? '' : 'sui-hidden'; ?>">
		<div class="sui-box-settings-col-1">
			<span class="sui-settings-label">
				<?php esc_html_e( 'Customize', 'wphb' ); ?>
			</span>
			<span class="sui-description">
				<?php esc_html_e( 'Choose your email preferences for the Uptime email reports.', 'wphb' ); ?>
			</span>
		</div>
		...
		<div class="sui-box-settings-col-2">
			<div class="sui-form-field">
				<label for="show_ping" class="sui-toggle">
					<input type="checkbox" name="show_ping" id="show_ping" aria-labelledby="show_ping-label" aria-describedby="show_ping-description" <?php checked( $data['show_ping'] ); ?>>
					<span class="sui-toggle-slider" aria-hidden="true"></span>
					<span id="show_ping-label" class="sui-toggle-label">
						<?php esc_html_e( 'Show average response time', 'wphb' ); ?>
					</span>
					<span id="show_ping-description" class="sui-description">
