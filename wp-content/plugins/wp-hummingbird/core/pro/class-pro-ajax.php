	...
	public function save_report_settings() {
		...
		if ( 'reports' === $type ) {
			...
			if ( 'performance' === $module ) {
				...
				$options['reports']['metrics']  = isset( $data['metrics'] ) && $data['metrics'];
				$options['reports']['audits']   = isset( $data['audits'] ) && $data['audits'];
				$options['reports']['historic'] = isset( $data['field-data'] ) && $data['field-data'];
			} elseif ( 'uptime' === $module ) {
				$options['reports']['show_ping'] = isset( $data['show_ping'] ) && $data['show_ping'];
			}
